      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0 text-white">
        ...
        <img
          className="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860px xl:w-6/12 px-4"
          src={require("assets/img/Logo_MBR.png").default}
          alt="..."
        />
      </section>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-12 px-12 md:px-4 mr-auto ml-auto -mt-32">
